...
GPU-accelerated hologram generation and hardware control system for creating dynamic optical trap patterns in real-time. Implements Gerchberg-Saxton algorithm with CUDA optimization for sub-frame latency updates.
